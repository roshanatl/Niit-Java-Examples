...
public class AccountDBCreate {
	...
	static public void  createAccount( Account user ) 
	{
	    ...
	    try {
	      ...
	      id++;
	      String sql = "INSERT INTO ACCOUNT (ID,NAME,ACCOUNTID,EMAIL,PHONE,PWD) " +
	                   "VALUES ( " + id + "," +"'"+ user.getName()+"'"+","+ "'"+user.getIdNumber()+"'"+ ","+ "'"+user.getEmail()+"'"+","+ "'"+user.getPhone()+"'"+ ","+ "'"+user.getPwd()+"'"+ ")";
